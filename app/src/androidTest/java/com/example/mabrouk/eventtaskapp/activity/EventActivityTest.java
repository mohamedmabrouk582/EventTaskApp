...
public class EventActivityTest {
    ...
    @Test
    public void eventActivityTest() {
        ViewInteraction recyclerView = onView(
                allOf(withId(R.id.events_recycler_view),
                        childAtPosition(
                                withId(R.id.my_events_stl),
                                0)));
        ...
        ViewInteraction appCompatTextView = onView(
                allOf(withId(R.id.title), withText("Favourites"),
                        childAtPosition(
                                childAtPosition(
                ...
                allOf(withId(R.id.search_button), withContentDescription("Search"),
                        childAtPosition(
                                allOf(withId(R.id.search_bar),
                                        childAtPosition(
                                                withId(R.id.app_bar_search_menu),
                                                0)),
                                1),
                        isDisplayed()));
        ...
        ViewInteraction searchAutoComplete = onView(
                allOf(withId(R.id.search_src_text),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete.perform(replaceText("mui"), closeSoftKeyboard());

        ViewInteraction searchAutoComplete2 = onView(
                allOf(withId(R.id.search_src_text), withText("mui"),
                        childAtPosition(
                                allOf(withId(R.id.search_plate),
                                        childAtPosition(
                                                withId(R.id.search_edit_frame),
        ...
        ViewInteraction searchAutoComplete3 = onView(
                allOf(withId(R.id.search_src_text), withText("mui"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete3.perform(replaceText("spr"));

        ViewInteraction searchAutoComplete4 = onView(
                allOf(withId(R.id.search_src_text), withText("spr"),
                        childAtPosition(
                                allOf(withId(R.id.search_plate),
                                        childAtPosition(
                                                withId(R.id.search_edit_frame),
        ...
        ViewInteraction searchAutoComplete5 = onView(
                allOf(withId(R.id.search_src_text),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete5.perform(replaceText("m"), closeSoftKeyboard());
        ...
        ViewInteraction searchAutoComplete8 = onView(
                allOf(withId(R.id.search_src_text),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete8.perform(replaceText("music"), closeSoftKeyboard());

        ViewInteraction searchAutoComplete9 = onView(
                allOf(withId(R.id.search_src_text), withText("music"),
                        childAtPosition(
                                allOf(withId(R.id.search_plate),
                                        childAtPosition(
                                                withId(R.id.search_edit_frame),
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete9.perform(pressImeActionButton());
